...
export default {
	...
	theme: {
		...
		extend: {
			...
			boxShadow: {
				'soft': '0 8px 30px rgba(0, 0, 0, 0.04), 0 4px 12px rgba(0, 0, 0, 0.02)',
				'medium': '0 12px 40px rgba(0, 0, 0, 0.06), 0 6px 16px rgba(0, 0, 0, 0.03)',
				'hard': '0 16px 50px rgba(0, 0, 0, 0.08), 0 8px 20px rgba(0, 0, 0, 0.04)',
